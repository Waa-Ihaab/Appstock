...
public class Edit_product extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label Add = new Label("Edit product");
        ...
        ConfirmButton.getStyleClass().add("Add_a_product-style");
        ConfirmButton.setOnAction(e -> {
        

        });
        
        ConfirmButton.getStyleClass().add("ResetButton-style");
        ...
        ConfirmButton.setTranslateX(85);
        ConfirmButton.setTranslateY(175);
        
        
        Scene scene = new Scene(root, 360,600);
        scene.getStylesheets().add(getClass().getResource("Styles5.css").toExternalForm());
